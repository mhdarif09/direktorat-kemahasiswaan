  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
      ...
      <section class="py-0" id="home" style="background-image: url('{{ asset('/img/bidar.jpeg') }}');">
        ...
        <div class="container">
          <div class="row align-items-center min-vh-75 text-center content">
            <div class="col-12">
              <h2 class="mt-5 mb-sm-3 display-3 lh-sm fs-2 fs-lg-3 fs-xxl-4 text-white">SELAMAT DATANG DI LAMAN</h2>
              <h1 class="display-3 fw-bold text-white">DIREKTORAT KEMAHASISWAAN</h1>
              <h3 class="display-4 fw-semi-bold lh-sm fs-3 fs-lg-4 fs-xxl-6 text-white">UNIVERSITAS BINA DARMA</h3>
              <div class="social-icons pt-3">
                <a href="https://www.instagram.com/ubd_palembang" target="_blank"><i class="fab fa-instagram"></i></a>
      ...
      <section class="article">
        ...
        {{-- Section Sambutan Direktur Kemahasiswaan --}}
        <section class="welcome-section">
          <div class="image-container">
            <img src="{{ asset('/img/illustrations/our-libraries.png') }}" alt="Director">
          </div>
          <div class="text-container">
            <h1>SAMBUTAN DIREKTUR KEMAHASISWAAN</h1>
            <p>
              Selamat datang di laman Direktorat Kemahasiswaan Universitas Bina Darma. Salah satu tugas utama dari Direktorat
              Kemahasiswaan adalah memberikan pelayanan kesejahteraan mahasiswa serta memfasilitasi penyelenggaraan program
              kegiatan kemahasiswaan. Dua tugas utama tersebut bermuara agar mahasiswa sebagai peserta didik dapat melakukan
              proses belajar mengajar dengan baik serta berprestasi baik dibidang akademik maupun non akademik, pada tataran
              nasional, regional, maupun global.
            </p>
            <p>
              Oleh karena itu, peran Direktorat Kemahasiswaan, sangat strategis untuk ikut berperan serta dalam memberikan
              warna masa depan bangsa dan negara. Jayalah mahasiswa, jayalah Indonesiaku.
            </p>
            <div class="btn-container">
              <button class="btn">SELEKNGKAPNYA</button>
            </div>
          </div>
        </section>
      ...
      {{-- Section Beasiiswa --}}
      <section class="scholarship-section container mt-5">
        <h1 class="text-center">FAQ BEASISWA UNIVERSITAS BINA DARMA</h1>
        <div id="scholarshipAccordion">
          <div class="card-custom">
            <p class="card-text">Beasiswa Prestasi</p>
            <span class="arrow-icon">&#x279C;</span>
          </div>
          <div class="card-custom">
            <p class="card-text">Beasiswa Bidikmisi</p>
            <span class="arrow-icon">&#x279C;</span>
          </div>
          <div class="card-custom">
            <p class="card-text">Beasiswa Penelitian</p>
            <span class="arrow-icon">&#x279C;</span>
          </div>
        </div>
      </section> 
    {{-- End Section beasiswa --}}
        <div class="container">
